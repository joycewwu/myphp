    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="btn-group-vertical categories" role="group" style="width: 100%;">
                <button type="button" class="btn btn-outline-primary" data-sid="0" onclick="changeCate(0)">全部商品</button>
                <?php foreach ($cate_rows as $c) : ?>
                    <button type="button" class="btn btn-outline-primary" data-sid="<?= $c['sid'] ?>" onclick="changeCate(<?= $c['sid'] ?>)"><?= $c['name'] ?></button>
                <?php endforeach; ?>
            </div>
        </div>
        <div class="col-lg-9">
...
<script>
    ...
    const productTpl = o => {
        return `<div class="col-md-3">
            <div class="card" >
                <img src="/myphp/proj/imgs/small/${o.book_id}.jpg" class="card-img-top" alt="">
                <div class="card-body">
